...
<html>
	...
	<body>
		<table class="flatTable">
			<tr class="headerTr">
				<td class="titleTd">Sample Web Application</td>
			</tr>
			<tr class="headerTr">
				<td><a href="/SampleWebApp/" >Home</a> &nbsp; &nbsp; <a href="/SampleWebApp/UserList" >List Users</a> &nbsp; &nbsp; <a href="/SampleWebApp/UserPages/UserAddEdit.jsp" >Add User</a></td>
			</tr>
		</table>
		<div class="page-wrap">